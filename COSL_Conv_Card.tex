...
%General approach:
\newcommand{\generalapproach}{Precision Club}
...
\newcommand{\ntnegtext}{vs. Strong NT} %Negative doubles over 1NT?
...
\newcommand{\majraisetext}{Bergen raises} %Text line for Bergen, fitjumps, etc
...
\newcommand{\diopennote}{may be short} % Insert text in blank space next to 1D e.g. ``4 unless 4-4-3-2'' 
...
\newcommand{\twohdescribe}{6-card suit}
...
\newcommand{\twosdescribe}{6-card suit}
...
\newcommand{\slamtexttop}{Coontrol-asking bids} %Two lines for slam convention info
