...
\begin{longtable}{ p{1.5cm}p{9.5cm} }
  ...
  \he{2}/\sp{} & 4-7\hcp, 6+-card suit, little strength
  ...
  {\color{blue}\di{3}} & {\color{blue}8-10\hcp, 4-4-4-1 shape with a red singleton. \he{3} is a
                         ...
                         respectively. A rebid in the singleton suit is a \emph{control
                         asking bid}.} \hyperlink{controlask}{\HandCuffRight} \\
  \he{3}/\sp{}, \cl{4}/\di{} & 11+\hcp, singleton in suit above
...
\begin{longtable}{ p{1.5cm}p{9.5cm} }
  ...
  \nt{1} & 16-18\hcp, balanced hand, no 5-card
         ...
         & \begin{tabular}{lp{6.5cm}}
             ...
             {\color{blue}\di{4}/\he{}} & {\color{blue}\emph{Texas} transfers to \he{4}/\sp{4}
                                          respectively.} \\
           \end{tabular} \\
  ...
  \he{1}/\sp{} & 4+-card suit, non-forcing. Responder's rebids are: \\
         & \begin{tabular}{lp{6.5cm}}
             ...
             {\color{blue}\emph{Game raise}} & {\color{blue}8+\hcp, good hand, 4+-card support.} \\
           \end{tabular} \\
  \cl{2}/\di{} & 5+-card suit, may have a 4-card major,
         ...
         & \begin{tabular}{lp{6.5cm}}
             ...
             \he{3}/\sp{} & 5-7\hcp\ \emph{Splinter}, 4+-card support for \cl{}/\di{}. \\
           \end{tabular} \\
  \he{2}/\sp{}, \cl{3}/\di{} & 22+\hcp, 5-card suit. Responder's rebids are: \\
         & \begin{tabular}{lp{6.5cm}}
  ...
  \he{3} & 25+\hcp, balanced hand, \underline{forcing}. Responder's rebids are: \\
         & \begin{tabular}{p{1.5cm}p{6.5cm}}
             \sp{3} & 0-4\hcp, puppet to \nt{3}. Opener rebids \nt{3} after
                      ...
                      5-6\hcp. \\
             \emph{4 of suit} & 5-6\hcp, 5+-cards. Opener bids
                                              one above suit (\di{4}/\he{4}/\sp{} or \nt{4}) to show
                                              fit and \emph{RKCB}.
...
the level of game is a \emph{control asking bid} and responses are in
steps as below:
...
\begin{longtable}{ p{2.5cm}p{8.5cm}  }
  \multicolumn{2}{l}{\emph{Opener's rebids after a positive minor suit response} \cl{1}--\cl{2}/\di{}}\\
  \hline
  \emph{New suit} & 5+-card suit, denies 3-card support for responder's
                    suit. Subsequent bids are natural to find the correct game
                    contract. \\
  \nt{2} & No 5-card suit and no slam interest. \\
  \emph{Raise to} \cl{3}/\di{} & $\beta$ \emph{control asking bid}. \hyperlink{controlask}{\HandCuffRight} \\
...
\begin{longtable}{p{3cm}p{8cm}  }
  ...
  {\color{blue}\emph{Cue bid}} & {\color{blue}Asks opener to bid a 4-card major if he has one,
...
\emph{Blackwood} should not be used when you have a void or two fast
losers.
...
\begin{longtable}{p{1.5cm}p{9.5cm}}
  ...
  \nt{2} & A puppet bid requiring opener to bid \cl{3}. After opener's
           forced \cl{3} bid: \\
                       & \begin{itemize}
                       \item 3 of a lower ranking suit than
                         overcaller's is natural, to play.
                       \item 3 of a higher ranking suit than
                         overcaller's is natural and invitational.
                       \item 3 of opponent's suit is artificial---like
                         \emph{Stayman}, it asks opener to bid a
                         4-card major, but it also shows a stopper in
                         opponent's suit.
                       \item 3NT is natural, to play, and shows a
                         stopper in overcaller's suit.
                       \end{itemize} \\
