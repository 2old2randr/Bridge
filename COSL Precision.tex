...
\newcommand{\forcing}{\fbox{forcing}}
...
\begin{longtable}{ p{1.5cm}p{9.5cm} }
  ...
  \he{2}/\sp{} & 4-7\hcp, 6+-card suit, \vone{two of top four honours (not AK)}.
  ...
  \vone{\nt{3}} & \vone{Solid 6/7-card suit and 1+ side control (if
                  7-carder, maybe no side control)} \\
  \vone{\cl{3}} & \vone{8-10\hcp, 4-4-4-1 shape with a
  ...
  \vone{\di{3}} & \vone{8-10\hcp, 4-4-4-1 shape with a
  ...
  \he{3}/\sp{}, \cl{4}/\di{} & 11+\hcp, 4-4-4-1 shape with singleton in suit above
                               the one bid. \vone{A rebid in the
...
\begin{longtable}{ p{1.5cm}p{9.5cm} }
  ...
  \nt{1} & 16-18\hcp, balanced hand, no 5-card
         ...
         & \begin{tabular}{lp{7.5cm}}
             ...
             \vone{\cl{4}} & \vone{\emph{Gerber} ace-asking.}
  ...
  \nt{2} & 19-21\hcp, balanced hand, no 5-card
         ...
         & \begin{tabular}{lp{7.5cm}}
             \emph{Pass} & 0-3\hcp. \\
             \cl{3} & 4-7\hcp, \emph{Stayman} \vone{(implies 4-card major)}.
                      \hyperlink{stayman}{\HandCuffRight} \\
  ...
  \cl{2}/\di{} & 5+-card suit, may have a 4-card major,
         ...
         & \begin{tabular}{lp{6.7cm}}
             ...
             \he{3}/\sp{} & 5-7\hcp\ \emph{Splinter} showing singleton
                            ...
                            for partner's suit. \\
           \end{tabular} \\
  \he{2}/\sp{}, \cl{3}/\di{} & 22+\hcp, 5-card suit\vone{---\underline{game force}}.
         ...
         & \begin{tabular}{lp{6.7cm}}
           ...
           \end{tabular} \\
  \he{3} & \vone{ 24+\hcp}, balanced hand, \underline{forcing}.
           Responder's rebids are: \\
  ...
  \nt{2} & Support for suit, \underline{game force}. Responders's
           rebids are:\\
              & \begin{tabular}{p{1.8cm}p{5cm}}
                ...
                \end{tabular} \\
  \vone{\nt{3}} & \vone{AQ or KQ in suit.} \\
  \vone{\nt{4}} & \vone{\emph{Roman Key-Card Blackwood}.
                  \hyperlink{blackwood}{\HandCuffRight}} \\
  \hline
\end{longtable}
  ...
  \he{2}/\sp{} & Weak jump shift, 5+-card suit,
              ...
              & \begin{tabular}{p{1.1cm}p{7cm}}
                  ...
                  \cl{3} & Shows both minors and asks responder to choose between
                           \cl{3}, \di{3} and \nt{3}. \\
                \end{tabular} \\
  \vone{\nt{2}} & \vone{15+\hcp, balanced, no 4-card major.} \\
...
\begin{longtable}{p{3cm}p{8cm}  }
  ...
  \vone{\emph{Suit at 3-level}} & Natural, \underline{Forcing to game}. \\
...
\vone{ Opener is showing a balanced hand with
