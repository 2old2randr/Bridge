...
since otherwise, responder is already limited to $<10$\hcp\ by virtue
of being a passed hand.
...
\begin{longtable}{ p{1.5cm}p{9.5cm}  }
  ...
  \cl{2} & \emph{Stayman}.\hyperlink{stayman}{\HandCuffRight} This can
...
\begin{longtable}{p{3cm}p{8cm}  }
  ...
  \nt{2} & \emph{lebensohl}---partner must bid
           \cl{3}.\hyperlink{lebensohl:nt}{\HandCuffRight} \\
  ...
  \nt{3} & \emph{lebensohl}---denies stopper in opponent's
           suit.\hyperlink{lebensohl:nt}{\HandCuffRight} \\
  \hline
\end{longtable}
...
\begin{longtable}{ p{2.5cm}p{8.5cm} }
  \hline
  \emph{Double} & $8^+$\hcp, negative double.\hyperlink{negative}{\HandCuffRight} \\
  \emph{Redouble} & 10+\hcp, no particular distribution. May be for
                    penalties. \\
...
\begin{longtable}{p{2.5cm}p{8.5cm} }
  ...
  \emph{Pass} & Waiting action. Partner will \emph{redouble} with a
                ...
                3-4-1-5 shape. \\
  \emph{Redouble} & Desire to play in diamonds with long suit.
...
\nt{2} after \cl{2}/\di{} or Double--\cl{2}--\he{2} shows game
...
elsewhere (likely to be partner's suit).
