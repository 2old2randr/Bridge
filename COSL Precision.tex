...
\begin{longtable}{ p{1.5cm}p{9.5cm} }
  ...
  \di{1} & 0-7\hcp, \forcing. Note that with an ace and a king (3 controls) either
           in the same suit or two different $4^+$-card suits, a
           positive response should be made.\hyperlink{1c1d}{\HandCuffRight} \\
  \multicolumn{2}{l}{\emph{\underline{Constructive Responses}}} \\
  \he{2}/\sp{} & 4-7\hcp, $6^+$-card suit, \vone{two of top four honours
                 (not \emph{AK})}.\hyperlink{1c2major}{\HandCuffRight} \\
  \multicolumn{2}{l}{\emph{\underline{Positive Responses}} \forcing{ to game}} \\
  \he{1}/\sp{}, \cl{2}/\di{} & $8^+$\hcp, $5^+$-cards in
                                suit. \vtwo{There are no
                                restrictions on suit quality}.\hyperlink{1csuit}{\HandCuffRight}\\
  \nt{1} & 8-13\hcp, balanced hand with no five-card suit.\hyperlink{1c1nt}{\HandCuffRight} \\
  ...
  \multicolumn{2}{l}{\emph{\underline{Unusual Positive---Three-suited hands}} \forcing{ to game}} \\
  \vtwo{\cl{3}} & \vtwo{8-11\hcp\ or $<4$ controls, 4-4-4-1 shape with a
                  black singleton (\sp{} or \cl{})}.\hyperlink{unusualpositive}{\HandCuffRight} \\
  \vtwo{\di{3}} & \vtwo{8-11\hcp\ or $<4$ controls, 4-4-4-1 shape with a
                  red singleton (\he{} or \di{})}.\hyperlink{unusualpositive}{\HandCuffRight} \\
  \vtwo{\he{3}, \nt{3},
  \cl{4}/\di{}} & \vtwo{$12^+$\hcp\ \underline{and} $4^+$-controls, 4-4-4-1 shape
                    with singleton in suit above the one bid (\sp{},
                    \cl{}, \di{}, \he{} respectively).}\hyperlink{unusualpositive}{\HandCuffRight} \\
  \hline
\end{longtable}
...
\begin{longtable}{ p{1.5cm}p{9.5cm} }
  ...
  \nt{1} & \vtwo{17-19\hcp}, balanced hand, no 5-card
         ...
         & \begin{tabular}{lp{7.5cm}}
             ...
             \di{2}/\he{} & 0-7\hcp, transfer to \he{2}/\sp{2} respectively.
                            ...
                            with 0-6\hcp\ unless opener super-accepts. \\
  ...
  \vtwo{\cl{3}/\di{}} & \vtwo{Very strong unbalanced hand with a long
                        minor and good playing strength that are too
  ...
  \vtwo{\he{3}/\sp{}} & \vtwo{Extremely powerful hand with a solid suit and
                        at least nine tricks. This bid sets trumps and asks responder to cue
                        bid an ace or void. E.g., \hhand{AKQJT98,4,KJ3,AK} or \hhand{65,AKQT7543,AKJ,}
                        where a slam is on if responder can cue bid.} \forcing{} Responder bids: \\
         & \begin{tabular}{lp{6.7cm}}
             \vtwo{\emph{Suit}} & \vtwo{First-round control---ace or void in suit.} \\
             \vtwo{\nt{3}} & \vtwo{No first round control but has a king or singleton in a non-trump suit.
...
\begin{longtable}{ p{2cm}p{9cm} }
  ...
  \emph{New suit} & Natural, \forcing. Responder's rebids are:\\
              & \begin{tabular}{p{1.8cm}p{6.3cm}}
                  ...
                  \emph{Cue bid under} \nt{3} & \vone{Maximum
                                                ...
                                                in suit bid. \\
                \end{tabular} \\
  \nt{2} & Support for suit, \vtwo{asking for shortness} \forcing{ to game.} Responders's
           rebids are:\\
  ...
  \vone{\nt{4}} & \vone{\emph{Roman Key-Card Blackwood}.\hyperlink{blackwood}{\HandCuffRight}} \\
  \hline
\end{longtable}
...
\vtwo{
  ...
  With a 4-4-4-1 distribution, if partner bids your singleton, you
  should rebid no-trumps. E.g., \nt{1} over \he{1} or \nt{2} over
  \di{2}. If partner rebids his suit, you should rebid \nt{} and he
  should get the message. Partner should cater to this possibility and
  insist on his suit as trumps only with a $6^+$-card suit.
}
...
\begin{longtable}{ p{1.5cm}p{9.5cm}  }
  ...
  \sp{1} &  8-15\hcp, 4-card \sp{}, denies 4-card \he{},
           \forcing. Opener's rebids have the
  ...
  \he{2}/\sp{} & Weak jump shift, $5^+$-card suit,
              ...
              & \begin{tabular}{p{1.1cm}p{7cm}}
                  ...
                  \cl{3} & Shows both minors and asks responder to choose between
                           \cl{3}, \di{3} and \nt{3}. \\
                \end{tabular} \\
  \vone{\nt{2}} & \vone{1$5^+$\hcp, balanced, no 4-card major.} \\
...
\begin{longtable}{ p{1.5cm}p{9.5cm}  }
  ...
  \cl{3} & \vtwo{7-10\hcp} with 4-card support (constructive \emph{Bergen} raise).\hyperlink{bergen}{\HandCuffRight} \\
  \di{3} & \vtwo{10-12\hcp} with 4-card support (limited \emph{Bergen} raise).\hyperlink{bergen}{\HandCuffRight} \\
...
\hypertarget{1nt}
A \nt{1} opening shows a \vtwo{14-16\hcp\ balanced hand (15-17\hcp\ in $3^{rd}$/$4^{th}$ seat)}
without a 5-card major holding but could be a 6-3-2-2 or 5-4-2-2 hand with a long minor
  ...
  \nt{2} & 11+\hcp, artificial \forcing{ to game} asks opener to
           further describe his hand. Opener's rebids are: \\
              & \begin{tabular}{lp{6.5cm}}
                ...
                \end{tabular} \\
              & \vtwo{A further rebid in diamonds by opener would be $\beta$
                asking for controls.\hyperlink{controlask}{\HandCuffRight}} \\
...
\begin{longtable}{p{3cm}p{8cm}}
  \emph{Honours shown} & \emph{Responses to repeat-ask} \\
  \hline
