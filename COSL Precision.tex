...
($12^+$\hcp) and must have tolerance for the unbid suits. The only
...
\begin{longtable}{>{\raggedright}p{2.5cm}p{8.5cm}}
  ...
  \emph{Suit} & 0-8\hcp, may be only four cards (forced
                response). Doubler should raise and invite with
                support and 15-17\hcp\ or bid a new suit or NT with
                $18^+$\hcp. \\
  \emph{Free bid or jump in suit} & 9-11\hcp. Doibler should compete
...
Over a double of a weak two opening, the response structure is:
\begin{longtable}{>{\raggedright}p{2.5cm}p{8.5cm}}
  \hline
  \emph{2 of suit} & Weak, 0-8\hcp. \\
  \nt{2} \emph{or 3
...
elsewhere (probably partner's suit).
...
\begin{longtable}{p{2.5cm}p{8.5cm}}
  ...
  \nt{2} & Artificial, partner must bid \cl{3}. Over
         ...
         & \begin{tabular}{lp{7cm}}
             ...
             \di{3}/\he{}/sp{} & 0-7\hcp, correct to longest suit when
                                 not clubs, sign-off. \\
...
\emph{lebensohl} applies even when \emph{RHO} raises opener to
the 2-level e.g., over the sequence (\sp{1})--\emph{Double}--(\sp{2})--???.
In this case, since responder is not forced to bid, with the weak
0-7\hcp\ hands, responder wil \emph{pass}. The suit bids after \nt{2}
and \cl{3} now become invitational hands and the direct raises to
three of a suit become game forces.
...
and diamonds. The \emph{unusual \nt{2}} is possible if one or both
opponents bid.
