...
\begin{longtable}{>{\raggedright}p{2cm}p{9cm}}
  ...
  \orf{\di{1}} & 0-7\hcp. Note that with an ace and a king (3
  ...
  \sp{} & 4-7\hcp, $6^+$-card suit with two of the top four honours
          but not both \emph{A} and \emph{K}.
...
\begin{longtable}{ p{1.5cm}p{9.5cm}}
  ...
  \nt{1} & 17-19\hcp, balanced, no 5-card major. Responder's rebids
           are: \\
...
hand of 4-7\hcp\ with a long suit, the opener needs to decide the best
...
\begin{longtable}{ p{2cm}p{9cm}}
  ...
  \orf{\cl{4}} & \emph{Roman key-card} ask with modified responses
...
black singleton and \di{3} is bid with a red singleton. With more than
4 controls (typically $12^+$\hcp), the singleton is immediately known
...
\hypertarget{1d} A \di{1} opening shows either a balanced hand of
11-13\hcp\ or an unbalanced hand with diamonds or clubs and
11-15\hcp. Although a \di{1} opening may be made on a doubleton
diamond, it is non-forcing and partner can pass with a weak hand.
...
\begin{longtable}{>{\raggedright}p{1.5cm}p{9.5cm}}
  ...
  \orf{\he{1}},
  \orf{\sp{1}} & Usually\footnote{Sometimes, with favourable
                 ...
                 opener.} $6^+$\hcp, $4^+$-card suit. \sp{1} denies
                 four cards in hearts but responder could have four
                 spades after bidding \he{1}. Opener rebids: \\
         & \begin{tabular}{p{1.5cm}p{7cm}}
             \orf{\sp{1}} & 4-card \sp{}, denies 4-card
                            \he{}. Responder rebids: \\
                    & \begin{tabular}{lp{5.5cm}}
                        \nt{1} & Minimum hand, sign-off. \\
                        \nt{2} & 11-12\hcp, balanced, invitational. \\
                        \orf{\cl{2}} & $10^+$\hcp, 4th suit forcing
                                       (``do something clever''). \\
                        \sp{2} & 8-9\hcp, 4-card \sp{}. \\
                      \end{tabular} \\
             \nt{1} & 11-14\hcp, balanced, denies 4-card fit. Can be
                      3-3-2-5 shape. Responder can rebid:
                      \marginnote{A \emph{reverse} by responder (\orf{\sp{2}}
                      after initial \he{1}) is forcing and indicates a
                      strong hand. New suits at the 3-level even
                      without a jump are forcing.} \\
                    & \begin{tabular}{lp{5.5cm}}
                        \orf{\cl{2}} & New minor \\
                        \di{2} & 8-9\hcp, 4-card \emph{spades} (after
                                 initial \he{1}). \\
                      \end{tabular} \\
             \cl{2} & Unbalanced, usually 5-4 in minors and no 4-card
                    ...
                    & \begin{tabular}{lp{5cm}}
                        ...
                        \nt{3} & To play. \\
                      \end{tabular} \\
             \di{2} & $6^+$-card diamond suit, non-forcing. \\
             \he{2},
             \sp{2} & Raise of responder's suit shows 3-4 card support
                      (if 3-card, it promises a singleton in a side
                      suit).
  ...
  \orf{\di{2}} & $11^+$\hcp, $5^+$-card diamond suit,
                 \underline{forcing to \nt{2} or \di{3}}. \\
  \di{3} & 0-10\hcp, $5^+$-cards in \di{}, usually with a singleton
           or void. \\
  \di{4} & Preemptive, with more shape and trumps than for \di{3},
           i.e., 6 or 7-card diamond suit. \\
  \multicolumn{2}{l}{\emph{\underline{Unbalanced hands}}} \\
  \orf{\cl{2}} & $10^+$\hcp, usually $5^+$-card suit and no 4-card major.
                 Opener's rebids are: \\
         & \begin{tabular}{lp{7cm}}
...
\begin{longtable}{>{\raggedright}p{2cm}p{9.5cm}}
  ...
  \gf{\he{2}} & $12^+$\hcp, $4^+$-card minor or 5-card heart suit
                ...
                \emph{passed hand} indicates 8-10\hcp\ with a good
...
(15-17\hcp\ in $3^{rd}$ or $4^{th}$ seat) without a 5-card major suit
...
\begin{longtable}{ p{2.5cm}p{8.5cm}}
  ...
  \gf{\emph{Cue-bid}} & 12+\hcp, singleton or void in opponent's
                        suit. \\
  \orf{\emph{New suit}} & Any new suit bid is forcing. \\
  \hline
\end{longtable}
...
\hypertarget{3preempt} A preempt at the 3-level should be made with at
least a 7-card suit and less than 10\hcp\ with a suit quality of 8
(non-vulnerable) or 9 (vulnerable). As per the rule of 2/3/4, opener
expects to make five tricks at favourable vulerability, six tricks at
equal vulnerability and seven tricks with unfavourable
vulnerability. In general, it is expected that opener will not have a
four-card major and have two or more good honours in his suit with not
more than one useful honour in a side suit. Unless partner makes a
forcing response, the opener is not expected to bid again.
...
\hypertarget{negative} Openers rebids after partner's takeout double
are as follows:
\begin{longtable}{p{2.5cm}p{8.5cm}}
  \hline
...
\nt{2} after \cl{2}, \di{2} (or \emph{Double}--\cl{2})--\he{2}) shows
...
cards, the $2^{nd}$ step (\he{4}) shows one key card without the queen
of trumps and the $3^{rd}$ step (\sp{4}) shows one key card with queen
of trumps. If partner signs off in \sp{4} after a 0/2 response, opener
bids \nt{4} with the trump queen allowing responder to push on to slam
if possible.
