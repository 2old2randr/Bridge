...
\begin{longtable}{ p{1.5cm}p{9.5cm} }
  ...
  \di{1} & 0-7\hcp, \forcing{} \hyperlink{1c1d}{\HandCuffRight} \\
  ...
  \cl{2}/\di{} & 5+-card suit, may have a 4-card major,
         ...
         & \begin{tabular}{lp{6.7cm}}
             ...
             \he{3}/\sp{} & 5-7\hcp\ \emph{Splinter} showing singleton
                            ...
                            for partner's suit. \\
           \end{tabular} \\
  \he{2}/\sp{}, \cl{3}/\di{} & 22+\hcp, 5-card suit\vone{---\forcing{ to game.}}
         ...
         & \begin{tabular}{lp{6.7cm}}
           ...
           \end{tabular} \\
  \he{3} & \vone{ 24+\hcp}, balanced hand, \forcing{}
           Responder's rebids are: \\
...
\begin{longtable}{ p{2cm}p{9cm} }
  ...
  \emph{New suit} & \forcing{} Responder's rebids are:\\
              & \begin{tabular}{p{1.8cm}p{6.3cm}}
                  ...
                  \emph{Cue bid under} \nt{3} & \vone{Maximum
                                                ...
                                                in suit bid. \\
                \end{tabular} \\
  \nt{2} & Support for suit, \forcing{ to game.} Responders's
           rebids are:\\
