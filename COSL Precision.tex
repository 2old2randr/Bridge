...
$4^+$-card spades) if he has a four-card major so any other bid
  denies four cards in either major suit. As a consequence,
...
in a new suit (which may be a six-card suit) is always non-forcing.
...
\begin{longtable}{>{\raggedright}p{0.75cm}p{10.25cm}}
  ...
  \orf{\sp{1}} & 4-card \sp{}, denies four cards in hearts. Responder
         ...
         & \begin{tabular}{>{\raggedright}p{2cm}p{7.25cm}}
             \sp{2} & Simple raise---8-9\hcp, 4-card spades. \\
             \sp{3} & Jump raise---10-11\hcp, 4-card spades,
                      invitational. \\
             ...
             \he{3} & $6^+$-card suit, 10-12\hcp, invitational. \\
