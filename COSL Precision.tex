...
All strong hands ({\color{blue}with one exception}\footnote{Balanced
  22-23 point hands are opened \nt{2}.}) are opened \cl{1} which is
...
\begin{longtable}{ p{1.5cm}p{9.5cm} }
  ...
  \he{2}/\sp{} & 4-7\hcp, 6+-card suit, {\color{blue}two of top four honours (not AK)}.
                         \hyperlink{1c2major}{\HandCuffRight} \\
  \multicolumn{2}{l}{\emph{\underline{Positive Responses (forcing to game})}} \\
  \he{1}/\sp{1}, \cl{2}/\di{} & 8+\hcp, 5+-cards in suit, can stop
  ...
  {\color{blue}\nt{3}} & {\color{blue}Solid 6/7-card suit and 1+ side control (if
                                     7-carder, maybe no side control)} \\
  {\color{blue}\cl{3}} & {\color{blue}8-10\hcp, 4-4-4-1 shape with a
                         black singleton. \di{3} is a relay and
                         \he{3}/\sp{3} would show \cl{}/\sp{} singleton
                         respectively. A rebid in the singleton suit
                         is a \emph{control asking bid}.}
                         \hyperlink{controlask}{\HandCuffRight} \\
  {\color{blue}\di{3}} & {\color{blue}8-10\hcp, 4-4-4-1 shape with a
                         red singleton. \he{3} is a relay and
                         \sp{3}/\nt{3} show a \di{}/\he{} singleton
                         respectively. A rebid in the singleton suit
                         is a \emph{control asking bid}.}
                         \hyperlink{controlask}{\HandCuffRight} \\
  \he{3}/\sp{}, \cl{4}/\di{} & 11+\hcp, 4-4-4-1 shape with singleton in suit above
...
\begin{longtable}{ p{1.5cm}p{9.5cm} }
  ...
  {\color{blue}\emph{New suit}} & {\color{blue}5-8\hcp, 5+-card suit.} \\
  {\color{blue}\emph{Double}} & {\color{blue}5+\hcp.} \\
  \multicolumn{2}{l}{\emph{{\color{blue}\underline{At 3-level}}}} \\
  {\color{blue}\emph{Double}} & {\color{blue}5+\hcp, takeout.} \\
  \multicolumn{2}{l}{\emph{{\color{blue}\underline{At 4-level}}}} \\
  {\color{blue}\emph{Double}} & {\color{blue}Weak hand.} \\
  {\color{blue}\emph{Pass}} & {\color{blue}\underline{\emph{Forcing pass}},
...
\begin{longtable}{ p{1.5cm}p{9.5cm} }
  ...
  \nt{1} & 16-18\hcp, balanced hand, no 5-card
         ...
         & \begin{tabular}{lp{7.5cm}}
             ...
             {\color{blue}\cl{4}} & {\color{blue}\emph{Gerber} ace-asking.}
                                    \hyperlink{gerber}{\HandCuffRight} \\
             {\color{blue}\di{4}/\he{}} & {\color{blue}\emph{Texas}]
  ...
  \nt{2} & 19-21\hcp, balanced hand, no 5-card
         ...
         & \begin{tabular}{lp{7.5cm}}
             \emph{Pass} & 0-3\hcp. \\
             \cl{3} & 4-7\hcp, \emph{Stayman} {\color{blue}(implies 4-card major)}.
                      \hyperlink{stayman}{\HandCuffRight} \\
             \di{3}/\he{} & $<$8\hcp, transfer to \he{3}/\sp{} respectively. \\
             \sp{3} & Transfer to minors. \\
             \nt{3} & 4-5\hcp, sign-off. \\
             \cl{4} & \emph{Gerber} ace-asking.
                      \hyperlink{gerber}{\HandCuffRight} \\
             \di{4}/\he{} & \emph{Texas} transfers to \he{4}/\sp{}
                              respectively. \\
           \end{tabular} \\
  \he{1}/\sp{} & 4+-card suit, non-forcing. Responder's rebids are: \\
  ...
  \cl{2}/\di{} & 5+-card suit, may have a 4-card major,
         ...
         & \begin{tabular}{lp{6.7cm}}
             ...
             \he{3}/\sp{} & 5-7\hcp\ \emph{Splinter} showing singleton
                            ...
                            for partner's suit. \\
           \end{tabular} \\
  \he{2}/\sp{}, \cl{3}/\di{} & 22+\hcp, 5-card suit{\color{blue}---\underline{game force}}.
         ...
         & \begin{tabular}{lp{6.7cm}}
             ...
             {\color{blue}\emph{Jump \nt{}}} & {\color{blue}4-7\hcp\
                                               maximum, spread values, no support.} \\
           \end{tabular} \\
  \he{3} & {\color{blue} 24+\hcp}, balanced hand, \underline{forcing}.
           Responder's rebids are: \\
         & \begin{tabular}{p{1.5cm}p{6.5cm}}
             \sp{3} & 0-4\hcp, puppet to \nt{3}. Opener rebids \nt{3} after
                      which \cl{4}/\di{}/\he{}/\sp{} will show 6+-cards and
                      5-6\hcp. \\
             \emph{4 of suit} & 5-6\hcp, 5+-cards. Opener bids one
                                above suit (\di{4}/\he{4}/\sp{} or \nt{4}) to show
                                fit and start \emph{Roman Key-Card Blackwood}.
...
\begin{longtable}{ p{2cm}p{9cm} }
  ...
  \nt{3}, \he{4}/\sp{} & Raise to game is a sign-off. \\
  \emph{New suit} & \underline{One-round force}. Responder's rebids are:\\
              & \begin{tabular}{p{1.8cm}p{6.3cm}}
                  ...
                  {\color{blue}{\nt{3}}} & {\color{blue}Maximum, no support.} \\
                  \emph{Cue bid under} \nt{3} & {\color{blue}Maximum
                                                with support,}
                                                singleton or void
                                                in suit bid. \\
                \end{tabular} \\
  ...
  {\color{blue}\nt{4}} & {\color{blue}\emph{Roman Key-Card Blackwood}.
                         \hyperlink{blackwood}{\HandCuffRight}} \\
  \hline
\end{longtable}
...
\subsubsection{\cl{1}--1NT--Suit Bid}
A bid of \di{2}/\he{}/\sp{} or \cl{3} over a response of \nt{1} shows
...
\subsubsection{\cl{1}--1NT--Raise NT}
A direct raise in no-trumps over responder's \nt{1} bid shows some slam
...
\begin{longtable}{ p{2.5cm}p{8.5cm} }
  ...
  major suit response} \cl{1}--\he{1}/\sp{1}}\\
  \hline
  ...
  \sp{3}, \cl{4}/\di{}/\he{} & \emph{Splinter} bid 4-card fit
                                   promised. \\
...
\begin{longtable}{ p{1.5cm}p{9.5cm}  }
              ...
              & \begin{tabular}{p{1.5cm}p{7cm}}
                  \sp{1} & 11-14\hcp, 4-card \sp{}, no 4-card
                         ...
                         & \begin{tabular}{lp{5.5cm}}
                           ...
                           \end{tabular} \\
                  \nt{1} & 11-14\hcp, balanced, denies 4-card fit.
                           Responder can rebid \\
                         & \begin{tabular}{ll}
                  ...
                  \cl{3} & 15\hcp, unbalanced, at least 5-5 in minors, no
                           4-card major. \\
                \end{tabular} \\
  \cl{2}/\di{} & 11-15\hcp, 4+-card suit, no 4-card major,
              ...
              & \begin{tabular}{lp{7cm}}
                ...
                \end{tabular} \\
  \he{2}/\sp{} & Weak jump shift, 5+-card suit,
  ...
  \he{3}/\sp{} & 6-9\hcp, 7+-card suit, invitational to game with
                   fit. \\
...
\emph{Splinter} bids, weak jump shifts, new-minor forcing bids and
4th-suit forcing approaches.
...
A response of \sp{1} over \he{1} shows 8-15\hcp\ with a 4-card suit
...
\begin{longtable}{p{3cm}p{8cm}  }
  ...
  {\color{blue}\emph{Suit at 3-level}} & Natural, \underline{Forcing to game}. \\
  {\color{blue}\emph{Cue bid}} & {\color{blue}Asks opener to bid a 4-card major
  ...
  \di{2} & 11+\hcp, conventional and \underline{forcing} (with club fit,
           may be made with only 8\hcp). Opener's rebids are: \\
              & \begin{tabular}{lp{7.5cm}}
                ...
                \end{tabular} \\
  \di{3}/\he{}/\sp{} & 16+\hcp, good 5-card suit. Opener rebids are: \\
              & \begin{tabular}{lp{7cm}}
...
\begin{longtable}{ p{2cm}p{9cm} }
  ...
  {\color{blue}\he{4}/\sp{}, \cl{5}} & {\color{blue}Sign-off, to play.} \\
  \hline
\end{longtable}
...
\begin{longtable}{ p{2.5cm}p{8.5cm} }
  ...
  \emph{New suit} & Natural, \underline{forcing}. Opener's rebids are: \\
              & \begin{tabular}{ll}
                ...
                \end{tabular} \\
  \nt{2} & \underline{Forcing}. Opener is asked to bid suit where he
...
{\color{blue} Opener is showing a balanced hand with
  ...
  is not opened with \cl{1}. Responses are: }

\begin{longtable}{ p{1.5cm}p{9.5cm} }
  \hline
  {\color{blue}\emph{Pass}} & {\color{blue}Very weak, no suit to escape to.} \\
  {\color{blue}\di{3}/\he{}} & {\color{blue}Weak hand that doesn't want to play in no-trumps.
                               \emph{Flint} convention---asks for a transfer to
                               \he{}/\sp{} respectively.} \\
  {\color{blue}\di{4}/\he{}} & {\color{blue}Transfer to \he{4}/\sp{} respectively.
                               6+-card suit, to play.} \\
  {\color{blue}\nt{3}} & {\color{blue}To play.} \\
  {\color{blue}\cl{3}} & {\color{blue}\emph{Smolen Stayman}---asking for majors.
                         Game-going with slam interest. Responses are:} \\
              & \begin{tabular}{lp{8.5cm}}
                  {\color{blue}\di{3}} & {\color{blue}No 4-card
                         ...
                         & \begin{tabular}{lp{7.5cm}}
                           ...
                           \end{tabular} \\
                  {\color{blue}\he{3}/\sp{}} & {\color{blue}4-card major.} \\
                  {\color{blue}\nt{3}} & {\color{blue}4 cards in both majors.
                                         Responder bids:} \\
                         & \begin{tabular}{lp{7.5cm}}
                           ...
                           \end{tabular} \\
                \end{tabular} \\
  {\color{blue}\sp{3}} & {\color{blue}Transfer to clubs with a
...
\begin{longtable}{p{1.5cm}p{9.5cm}}
  ...
  \emph{New suit} & \underline{Forcing for one round}. \\
  \emph{Others} & Natural. \\
  \hline
\end{longtable}
...
A $\beta$ control asking bid can occur either
after a \nt{1} rebid by the \cl{1} opener over a positive suit
response or by cue bidding a singleton suit after a positive response
of \cl{3}, \di{3}, \he{3}, \sp{3}, \cl{4} or \di{4} over \cl{1}.
...
\underline{forcing to game}. Opener's rebids are:
