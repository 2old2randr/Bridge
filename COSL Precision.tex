...
\begin{longtable}{>{\raggedright}p{1.5cm}p{9.5cm} }
  ...
  \he{2}/\sp{} & 4-7\hcp, $6^+$-card suit with two of the top four honours
                 but not \emph{AK}.\hyperlink{1c2major}{$\Rightarrow$} \\
  ...
  \he{1}/\sp{}, \cl{2}/\di{} & $8^+$\hcp, $5^+$-cards in suit. There
                               ...
                               quality.\hyperlink{1csuit}{$\Rightarrow$} \\
  ...
  \multicolumn{2}{l}{\emph{\underline{Unusual positive---three-suited hands}}
                     \forcing{ to game}} \\
  \cl{3} & 8-11\hcp\ or less than four controls, 4-4-4-1 shape with a black
           singleton (\sp{} or
           \cl{}).\hyperlink{unusualpositive}{$\Rightarrow$} \\
  \di{3} & 8-11\hcp\ or less than four controls, 4-4-4-1 shape with a red
           singleton (\he{} or
           \di{}).\hyperlink{unusualpositive}{$\Rightarrow$} \\
  \he{3}, \nt{3},
  \cl{4}/\di{} & $12^+$\hcp\ \underline{and} $4^+$-controls, 4-4-4-1
                 shape with singleton in suit above the one bid
                 (\sp{}, \cl{}, \di{}, \he{}
                 respectively).\hyperlink{unusualpositive}{$\Rightarrow$} \\
  \hline
\end{longtable}
...
\hypertarget{1c1d}
Opener rebids no-trumps with balanced hands (\nt{1}: 17-19\hcp, \nt{2}: 20-21\hcp,
\nt{3}: 24-26\hcp), a 5-card suit with 16-21\hcp\ and
jumps in a 5-card suit with powerful hands ($22^+$\hcp). The jump rebid may be
made with a lower point-count with greater playing strength.

\hyperlink{ex1c1d}{Bidding Examples$\Rightarrow$}

\begin{longtable}{ p{1.5cm}p{9.5cm} }
  \hline
  \multicolumn{2}{l}{\emph{\underline{Balanced hands}}} \\
  \nt{1} & 17-19\hcp, balanced, no 5-card major. Responder's
           rebids are: \\
         & \begin{tabular}{lp{7.5cm}}
             \emph{Pass} & 0-5\hcp, no major suit to escape to. \\
             \cl{2} & 6-7\hcp, \emph{Stayman}.\hyperlink{stayman}{$\Rightarrow$} \\
             \di{2}/\he{} & 0-7\hcp, transfer to \he{2}/\sp{2} respectively.
                            Responder will invite with 7\hcp\ and pass
                            with 0-6\hcp\ unless opener
                            \emph{super-accepts}.\hyperlink{superaccept}{$\Rightarrow$} \\
  ...
  \nt{2} & 20-21\hcp, balanced, \emph{may have a 5-card
         ...
         & \begin{tabular}{lp{7.5cm}}
             ...
             \cl{3} & 4-7\hcp, \emph{Puppet Stayman} asking for 5-card majors if
                      any.\hyperlink{puppetstayman}{$\Rightarrow$} \\
  ...
  \nt{2} & Support for suit, asking for shortness \forcing{ to
           game.} Responders's rebids are:\\
              & \begin{tabular}{p{1.8cm}p{5cm}}
                  \emph{Rebid suit} & Minimum, no singleton or void. \\
...
\begin{longtable}{ p{1.5cm}p{9.5cm} }
  ...
  \di{2} & 8-10\hcp, 4 card \he{}, may have 4 card
         ...
         & \begin{tabular}{lp{7cm}}
             \he{2} & \he{} fit confirmed, relay; responder should then bid
                      \nt{2} with 4-3-3-3 or a second suit at 3-level. \\
             \sp{2} & 4-card \sp{}, no 4-card \he{}. \\
             \nt{2} & No 4-card major. \\
           \end{tabular} \\
  \he{2} & 8-10\hcp, 4 card \sp{}, denies 4-card \he{}. Opener rebids: \\
         & \begin{tabular}{lp{7cm}}
...
Any suit bid after a support-asking bid would be an $\epsilon$ control-asking
bid in that suit.\hyperlink{epsilon}{$\Rightarrow$}
...
\begin{longtable}{ p{2.5cm}p{8.5cm} }
  ...
  \di{3}/\he{}/\sp{}, \cl{4} & $5^+$-card suit. Subsequent bidding is natural. \\
...
\hyperlink{ex1suit}{Bidding Examples$\Rightarrow$}
...
\begin{longtable}{ p{2.5cm}p{8.5cm} }
  ...
  \nt{1} & 17-19\hcp, balanced (\nt{2} over \cl{2}/\di{2}).
           ...
           After \he{1}/\sp{}, a \emph{jump rebid} of the suit shows a semi-solid
  ...
  \emph{Game raise} & Minimum balanced hand, 4-card fit with poor
                      controls. \\
  \sp{3}, \cl{4}/\di{}/\he{} & \emph{Splinter} bid with 4-card fit promised. \\
...
\hyperlink{ex1c3s}{Bidding Examples$\Rightarrow$}

\subsection{Bidding after an \emph{unusual positive} response}

\hypertarget{unusualpositive}
An \emph{unusual positive} response shows a 4-4-4-1 distribution. With less
...
\hypertarget{1d}
A \di{1} opening shows either a balanced hand of 11-13\hcp\ or an
unbalanced hand with diamonds or clubs and 11-15\hcp. Although a \di{1}
...
\begin{longtable}{ p{1.5cm}p{9.5cm}  }
  ...
  \multicolumn{2}{l}{\emph{\underline{Major suit at 1-level}}} \\
  \he{1}/\sp{} & Usually\footnote{Sometimes, with favourable
                 vulnerabilty and an extremely weak hand, a tactical
                 bid may be made to interfere with opponent's game. E.g.,
                 ...
                 in hearts but responder could have four spades after
                 bidding \he{1}. \forcing{} Opener rebids: \\
              & \begin{tabular}{p{1.5cm}p{7cm}}
                  \sp{1} & 4-card \sp{}, denies 4-card
                           \he{}. Responder rebids: \\
                         & \begin{tabular}{lp{5.5cm}}
                             \nt{1} & Minimum hand, sign-off. \\
                             \nt{2} & 11-12\hcp, balanced, invitational. \\
                             \cl{2} & $10^+$\hcp, 4th-suit-\forcing{}
                                      (``do something clever''). \\
                             \sp{2} & 8-9\hcp, 4-card \sp{}. \\
                           \end{tabular} \\
                  \nt{1} & 11-14\hcp, balanced, denies 4-card fit. Can be 3-3-2-5 shape.
                           Responder can rebid \marginnote{A reverse by responder (\sp{2} after initial \he{1}) is forcing and indicates a strong hand. New suits at the 3-level even without a jump are forcing.} \\
                         & \begin{tabular}{ll}
                ...
                \end{tabular} \\
  \multicolumn{2}{l}{\emph{\underline{Balanced hands}}} \\
  \nt{1} & 8-10\hcp, no 4-card major, usually balanced hand. \\
  ...
  \di{2} & $11^+$\hcp, $5^+$-card diamond suit. \forcing{ to \nt{2} or \di{3}} \\
  ...
  \multicolumn{2}{l}{\emph{\underline{Unbalanced hands}}} \\
  \cl{2} & $10^+$\hcp, usually $5^+$-card suit, no 4-card major,
...
\begin{longtable}{>{\raggedright}p{2cm}p{9.5cm}}
  ...
  \emph{Jump raise} & 0-6\hcp\ with 4-card support (pre-emptive
                        \emph{Bergen} raise).\hyperlink{bergen}{$\Rightarrow$} \\
...
$3^{rd}$ or $4^{th}$ seat) without a 5-card major suit (a 5-card minor
is possible). Simple arithmetic will almost always tell responder how
high to place the contract. E.g., 0-8\hcp: 1NT or 2 of suit, 9-10\hcp:
game invite, 11-17: game force, 18+: slam. The response structure
below is applicable when \nt{1} is opened in $1^{st}$ or $2^{nd}$ seat
since otherwise, responder is already limited to less than $11$\hcp.
...
\begin{longtable}{ p{1.5cm}p{9.5cm}  }
  ...
  \cl{2} & \emph{Stayman}.\hyperlink{stayman}{$\Rightarrow$} This can
  ...
  \di{2}/\he{} & \emph{Jacoby}
                 ...
                 and weak hands. \\
  \sp{2} & Minor suit \emph{Stayman}---shows a minor 2-suiter (5-4 or
           ...
           want to play \nt{3} so asking for minors is not
  ...
  \cl{4} & \emph{Gerber} ace-asking.\hyperlink{gerber}{$\Rightarrow$} \\
...
\begin{longtable}{ p{1.5cm}p{9.5cm}  }
  ...
  \emph{Redouble} & \emph{SOS} with $5^+$-card suit, asking partner to bid \cl{2} and then
                    pass or rectify. \\
...
\begin{longtable}{p{3cm}p{8cm}  }
  ...
  \nt{2} & \emph{lebensohl}---partner must bid
           \cl{3}.\hyperlink{lebensohl:nt}{$\Rightarrow$} \\
  ...
  \nt{3} & \emph{lebensohl}---denies stopper in opponent's
           suit.\hyperlink{lebensohl:nt}{$\Rightarrow$} \\
  \hline
\end{longtable}
...
asks opener to further describe his hand. Note that a direct \di{4} (not \nt{4})
is used to trigger ace-asking.
  ...
  \di{2} & 11+\hcp, conventional and \forcing{} (with club fit,
           may be made with only 8\hcp). Opener's rebids are: \\
              & \begin{tabular}{lp{7.5cm}}
                ...
                \end{tabular} \\
  \di{3}/\he{}/\sp{} & $6^+$-card suit with \underline{game-forcing values} ($12^+$\hcp).
                       Opener's rebids are: \\
              & \begin{tabular}{lp{7cm}}
                  \nt{3} & Less than 2-card support. \\
                  \emph{Raise} & Minimum, 3-card support. \\
                  \emph{New suit} & Maximum, 3+-card support, cue-bid ace or void.  \\
                \end{tabular} \\
  \nt{3} & 13-15\hcp, balanced hand with stoppers in the unbid suits
           and no interest in the majors. \\
  \di{4} & Ace-asking, \emph{Roman key-card Blackwood}\hyperlink{blackwood}{$\Rightarrow$} \\
  \hline
\end{longtable}

\hyperlink{ex2c}{Bidding Examples$\Rightarrow$}

\subsection{Intervention after a \cl{2} opening}

After an opponent's double, all bids carry their normal meaning.
The extra bid of \emph{Redouble} shows $10^+$\hcp\ and is penalty oriented.

Over an opponent's overcall, raises are natural. Others:
\begin{longtable}{ p{2.5cm}p{8.5cm} }
  \hline
  \emph{Double} & $8^+$\hcp, negative double.\hyperlink{negative}{$\Rightarrow$} \\
...
most cases. The only positive responses are the artificial bids of \nt{2}
or \di{3} (both forcing to game).
  ...
  \nt{2} & 11+\hcp, artificial \forcing{ to game} asks opener to
           further describe his hand. Opener's rebids are: \\
              ...
              & A further rebid in diamonds (the singleton suit) by
                ...
                controls.\hyperlink{beta}{$\Rightarrow$} \\
...
\hyperlink{ex2d}{Bidding Examples$\Rightarrow$}
...
\begin{longtable}{p{2.5cm}p{8.5cm} }
  \hline
  \emph{Pass} & Waiting action. Partner will \emph{redouble} with a
                minimum hand or bid \he{2}/\sp{} (4-card suit) with a
                3-4-1-5 shape. \\
  \emph{Redouble} & Desire to play in diamonds with a long suit.
                    Prepared to punish the opponents when they run
                    from the redouble. \\
...
Opener is showing a balanced hand with 22-23\hcp. Note that the rebids after a \cl{3}
response differ from those after \cl{1}--\di{1}--\nt{2}
...
\begin{longtable}{ p{1.5cm}p{9.5cm} }
  ...
  \nt{3} & To play. \\
  \cl{3} & \emph{Smolen Stayman}---asking for majors (implies at least one four-card major). Game-going with
              ...
              & \begin{tabular}{lp{7.7cm}}
                  ...
                  \nt{3} & 4 cards in both majors. Responder bids: \\
                          & \begin{tabular}{lp{5.5cm}}
                            ...
                            \end{tabular} \\
                \end{tabular} \\
  \di{3}/\he{} & Transfer to \he{}/\sp{} respectively.
                          
                        With 5-5 in the majors, responder bids \sp{3} after a transfer to hearts.
                        With 5-4 (four hearts), he bids \he{4} after
                        a transfer to spades. Bidding \nt{3} asks opener to pass or bid four of
                        the major holding 3-card support. \\
  \sp{3} & Minor suit slam try. Opener bids \cl{4} (corrected to \di{4} if needed). \\
  \cl{4} & Minor two-suiter. \di{4} sets diamonds, any other bid agrees clubs. \\
...
\hypertarget{3nt}
The ``gambling'' \nt{3} bid shows a solid $7^+$-card minor suit
...
\hyperlink{ex3nt}{Bidding Examples$\Rightarrow$}
...
level in an auction such as (\he{1})--\emph{Double}--(\he{2})--???) the
responses are:
...
\begin{longtable}{l|p{5cm}>{\raggedright\arraybackslash}p{3cm}}
  ...
  \di{1}--(\cl{2})--\emph{Double}
                 & Reasonable major suit holdings and
                   strength to play at two-level.
...
Openers rebids after partner's takeout double are as follows:
\begin{longtable}{p{2.5cm}p{8.5cm}}
  \hline
  ...
  \emph{Jump in \nt{}} & Stopper in opponent's suit, ready source of
                         tricks. \\
  \emph{Cue-bid} & Shortness in opponent's suit and by implication,
                   support for doubler's suits. \forcing{} \\
\hline
\end{longtable}
...
suit). For example, after \di{1}--(\cl{2})--\emph{Double}, opener
could pass with \hhand{5,A76,AKJ3,QT942} or \hhand{983,Q,AK865,KQJ9}
(but not with \hhand{QT65,9,AKT,KT32} where the correct bid would be to
support one of partner's implied suits with \sp{2}).
...
\begin{longtable}{ p{1.5cm}p{9.5cm}}
  ...
  \emph{Double} & Single-suited minor or major two-suiter (5-4 or
                ...
                & \begin{tabular}{lp{7cm}}
                  ...
                  \end{tabular} \\
  \cl{2}/\di{} & Two-suiter---clubs/diamonds and a major
...
\hypertarget{gamma}
The $\gamma$ trump-asking bid is used to find out the quality of responder's
suit, i.e.,  whether the suit will provide enough tricks in no-trumps or as a trump suit.
...
\begin{longtable}{p{4cm}p{7cm}}
  ...
  \hline
  \emph{Zero} or \emph{AKQ} & \begin{tabular}{lp{5cm}}
                                1 step & $7^+$-card suit \\
                                2 steps & 6-card suit \\
                                3 steps & 5-card suit \\
                          \end{tabular} \\
...
\hypertarget{lebensohl:weak}
The \emph{lebensohl} convention is used to respond to partner's
takeout double of a weak two opening. This system is geared to show
weak, invitational and strong hands without consuming too much bidding
room.

\begin{longtable}{p{2.25cm}p{8.5cm}}
  \hline
  \nt{2} & Artificial, partner must bid \cl{3}. Over
           partner's forced response, responder bids: \\
         & \begin{tabular}{lp{6.3cm}}
             \emph{Pass} & 0-7\hcp, sign-off in clubs. \\
             \di{3}/\he{}/\sp{} & 0-7\hcp, correction to longest suit when
                                 not clubs, sign-off. \\
             \emph{Cue-bid} & $4^+$-cards in unbid major (or one major
                              if double was over 2 of a minor),
                              confirms stopper in opponent's
                              suit. \forcing{ to game} \\
             \nt{3} & Denies $4^+$-cards in majors, confirms stopper in
                      opponent's suit. \forcing{ to game} \\
           \end{tabular} \\
  \cl{3}/\di{}/\he{}/\sp{} & 8-11\hcp, $4^+$-card suit,
                             invitational. \\
  \emph{Cue-bid} & $4^+$-cards in unbid major (or one major if double
                   was over 2 of a minor), no stopper in opponent's
                   suit. \forcing{ to game} \\
...
\subsection{lebensohl convention (over 1NT)}

\hypertarget{lebensohl:nt}
The \emph{lebensohl} convention is also used by responder after an
opponent overcalls partner's opening \nt{1} bid in order to compete
further without necessarily committing to game. It is initiated after
the right-hand opponent makes a suit overcall at the two-level.
...
\hypertarget{michaels}
A cue-bid in the opponent's suit after they have opened the bidding is
conventional and shows a two-suited hand (5-5 or better). Over a
minor-suit opening (i.e., \cl{2}/\di{}) shows a major two-suiter and
over a major-suit (i.e., \he{2}/\sp{}), it shows the unbid major and
...
\begin{longtable}{>{\raggedright}p{3.2cm}|p{1cm}>{\raggedright}p{3cm}>{\raggedright\arraybackslash}p{3.2cm}}
  ...
  \\
  \emph{2/5 key cards
  with queen of trumps} & \sp{5} & \di{5} (\underline{two} key cards) & \emph{Second-cheapest suit} (\underline{two} key cards)\\
...
\hypertarget{unusualnt}
A jump to \nt{2} over opponent's opening of one of a suit is
conventional and shows a two-suited hand in the two lowest ranking
unbid suits. E.g., a \nt{2} overcall of a \cl{1} opener shows hearts
and diamonds. The \emph{unusual \nt{2}} is possible even when both
opponents bid.
